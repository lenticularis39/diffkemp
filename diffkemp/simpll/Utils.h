...
/// Check if the function name contains a suffix generated by linker or SimpLL.
/// This is either a number suffix (generated by the LLVM linker or SimpLL in
/// the case of an abstraction function) or a void suffix (generated by SimpLL).
bool hasSuffix(std::string Name);

/// Remove all suffixes generated by linker or SimpLL.
std::string dropSuffixes(std::string Name);

// Attempts to find matching names of the global values and saves them
// (without suffixes) into Result.
